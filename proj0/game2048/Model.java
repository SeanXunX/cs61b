    ...
    public static boolean atLeastOneMoveExists(Board b) {
        ...
        for (int i = 0; i < b.size(); i++) {
            for (int j = 0; j < b.size(); j++) {
                ...
                if (i - 1 >= 0 && temp == b.tile(i - 1, j).value()) {
                    return true;
                } else if (i + 1 < b.size() && temp == b.tile(i + 1, j).value()) {
                    return true;
                } else if (j + 1 < b.size() && temp == b.tile(i, j + 1).value()) {
                    return true;
                } else if (j - 1 >= 0 && temp == b.tile(i, j - 1).value()) {
                    return true;
                }
            }
        }
